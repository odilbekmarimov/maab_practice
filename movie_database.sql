...
insert into reviewer values ('Righty Sock'),
('Jack Malvern'),
('Flagrant Baronessa'),
('Alec Shaw'),
(null),
...
-----
select rev_name, rev_stars from reviewer, rating
...
inner join rating using (reviewer.rev_id=rating.rev_id) where rev_stars is null
